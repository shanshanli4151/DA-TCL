...
from ihdphelpers import truncate_all_by_g, cross_entropy, mse
...
#干扰的q相当于预测的参数
#返回与给定数组具有相同形状和类型的新数组，但新数组的所有元素都是1。
    def q1(t_cf, epsilon):
...
接近规范的 van der Laan TMLE，不同之处在于我们使用了 Q 和 g 更新模型之间共享的 1 维 epsilon
    """
...
#此干扰q,g与上干扰的区别？
    ...
    def tmle(q_t0, q_t1, g, t, y, truncate_level=0.05, deps=deps_default):
        """
        Computes the tmle for the ATT (equivalently: direct effect，直接效果)
